...
def training_lstm_model(
    ...
    version=1,
    model_name=None,
    activation_for_output=torch.tanh,
):
    data_client, train_dl, val_dl, frame, kinds, i, o = __create_dataloaders(
        data_client=data_client,
        dataset=dataset,
        idc_processes=idc_processes,
        pre_processes=pre_processes,
...
def training_lenear_auto_encoder(
    data_client=None,
    dataset=None,
    batch_size=32,
    observationLength=100,
    ...
    data_client, train_dl, val_dl, frame, kinds, input, output = __create_dataloaders(
        data_client=data_client,
        dataset=dataset,
        batch_size=batch_size,
        observationLength=observationLength,
...
def training_lstm_auto_encoder(
    data_client=None,
    dataset=None,
    batch_size=32,
    observationLength=100,
