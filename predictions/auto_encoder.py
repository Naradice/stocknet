...
def training_auto_encoder_macd(data_client, batch_size, observationDays, processes, columns, epoc_num=-1, hidden_layer_num = 5, middle_layer_size = 48, version=1):
...
if __name__ == "__main__":
    ...
    data_client = fc.CSVClient(file='data_source/bitcoin_5_2017T0710-2021T103022.csv', idc_processes=[macd_ps])
    columns = []
    ...
    training_auto_encoder_macd(data_client, batch_size, observationDays, processes, columns, hidden_layer_num=hidden_layer_size, middle_layer_size=middle_layer_size)
