...
model_name = 'rl/bc_5min/macd/Dense16_mono_v1'
max_step = 1000
...
env = BCEnv(data_client, columns=[],max_step=max_step, observationDays=3,useBudgetColumns=True, use_diff=True)
...
model = SimpleDense(16,size, inputDim, 3, removeHistoryData=False, lr=True) #modelの宣言
