...
from stocknet.datasets import base, utils
...
class TestBaseDataset(unittest.TestCase):
    ...
    def test_01_get_params(self):
        src = "L://data/fx/OANDA-Japan MT5 Live/mt5_USDJPY_min30.csv"
        processes = [finance_client.fprocess.DiffPreProcess(), finance_client.fprocess.MinMaxPreProcess()]
        columns = ["open", "high", "low", "close"]
        dataset = base.Dataset(source=src, columns=columns, observation_length=60, prediction_length=10, processes=processes)
