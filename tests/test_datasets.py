...
class TestDatasets(unittest.TestCase):
    ...
    def test_shift(self):
        ...
        out_columns.pop(0)
        shift = 1
        dataset = ds.ShiftDataset(data_client=data_client, observationLength=observationLength, in_columns=ohlc_columns, out_columns=out_columns, shift=shift, isTraining=True)
        i,o = dataset[0]
    ...
    def test_shift_merged(self):
        ...
        out_columns.pop(0)
        shift = 1
        dataset = ds.ShiftDataset(data_client=data_client, observationLength=observationLength, in_columns=ohlc_columns, out_columns=out_columns, shift=shift, merge_input_columns=True)
        i,o = dataset[0]
